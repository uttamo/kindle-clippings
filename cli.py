...
parser.add_argument('-i', '--input', default='My Clippings.txt', help='Input filename')
...
# a = parser.parse_args(['clippings.txt', '-t'])
# print(a)
...
if __name__ == '__main__':
    ...
    output_filename = namespace.input
    ...
    if html_output and not plaintext_output:
        output_html(input_filename, f'{output_filename}.html')
    else:
        output_plaintext(input_filename, f'{output_filename}.txt')
